...
\begin{minipage}{0.5\hsize}
    \centering
    \includegraphics[width=4cm]{chap2/piechart.png}
    \caption{円グラフ}
    \label{fig:piechart}
\end{minipage}
\end{figure}
...
\begin{figure}[tb]
    ...
    \begin{minipage}{0.5\hsize}
        \centering
        \includegraphics[width=3cm]{chap2/piechart_label_option.png}
        \caption{ラベルの書式設定}
...
例として，前回の演習で用いたアヤメのがく片の長さと幅 (iris.xlsx) の散布図(図\ref{fig:scatter})を示します．
...
それでは，散布図を実際に描いてみましょう．
散布図も他のグラフの書き方と同じですが，データの列を2つ選ぶ点が異なります．

\begin{enumerate}
    \item データを開きます．今回は，アヤメデータiris.xlsxを用います．
...
\begin{enumerate}
    \item データを開きます．今回も先程用いたアヤメデータiris.xlsxを用います．
...
\begin{figure}[htbp]
    ...
    \begin{minipage}{0.5\hsize}
    \centering
    \includegraphics[width=4cm]{chap2/regression_menu.png}
    \caption{散布図}
...
\practice
temp\_city.xlsxファイルから棒グラフを作りなさい．ただし，横軸は都市，縦軸は気温(度)にしなさい．

\practice
2019年4月8日の小松市の気温データtemp.xlsxから折れ線グラフを作りなさい．ただし，横軸は時間(時)，縦軸は気温(度)にしなさい．

\practice
2020年4月21日までの石川県内のコロナウイルス感染者情報COVID-19\_Ishikawa.xlsx\footnote{SIGNATEのCOVID-19 Challengeで作成されているデータを用いました．https://signate.jp/competitions/261}から，感染者の男女の割合を円グラフで表しなさい．

\practice
私鉄の資本金と従業員数のデータshitetsu.xlsxから散布図をかきなさい．ただし，横軸は資本金，縦軸は従業員数にしなさい
\footnote{http://www.qmss-matsubara.sakura.ne.jp/databank/index.htmlの私鉄データを用いました．}．

\practice
私鉄の資本金と従業員数のデータshitetsu.xlsx内の資本金と従業員数の相関係数を求めなさい．

\practice
演習4で作成した散布図に回帰直線を加えたものを作成しなさい．
